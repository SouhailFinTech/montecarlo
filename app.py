...
if run_button:
    ...
    # Download data via Alpha Vantage
    st.info(f"📊 Fetching '{ticker.upper()}' data from Alpha Vantage...")
    ...
    if df is not None:
        ...
        daily_returns = np.exp(drift + stdev * np.random.normal(size=(days, simulations)))
        ...
        st.warning("⚠️ No valid data received – check your ticker symbol or API key")
